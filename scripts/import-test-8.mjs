...
const publicContent = JSON.parse(await readFile(path.join(root, "content/test-8.public.json"), "utf8"));
const privateAnswers = JSON.parse(await readFile(path.join(root, "content/test-8.private.json"), "utf8"));
